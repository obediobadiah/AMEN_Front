...
export function ProjectsDialog({ open, onOpenChange, onSubmit, project, isSubmitting }: ProjectsDialogProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[850px] max-h-[90vh] overflow-y-auto rounded-[2.5rem] border-none shadow-2xl p-0 selection:bg-primary selection:text-white">
                        ...
                        <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-slate-900">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="space-y-4">
                                            <FormLabel className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 pl-1">{t("impactLabel")}</FormLabel>
                                            <FormControl>
                                                <div className="relative">
                                                    <Target className="absolute left-6 top-1/2 -translate-y-1/2 w-5 h-5 text-primary" />
                                                    <Input placeholder="e.g. 50k Trees, 12 Wells" className="h-16 rounded-2xl bg-white border-slate-100 shadow-sm font-black pl-14 pr-8 focus-visible:ring-primary/20 focus-visible:border-primary transition-all placeholder:text-slate-300 placeholder:font-medium" {...field} />
                                                </div>
                                            </FormControl>
                                            <FormMessage className="text-xs font-bold text-rose-500 pl-1" />
                                        </FormItem>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="space-y-4">
                                        ...
                                        <FormControl>
                                            <Input placeholder={t("descPlaceholder")} className="h-16 rounded-2xl bg-white border-slate-100 shadow-sm font-bold px-8 focus-visible:ring-primary/20 focus-visible:border-primary transition-all placeholder:text-slate-300" {...field} />
                                        </FormControl>
                                        <FormMessage className="text-xs font-bold text-rose-500 pl-1" />
                                    </FormItem>
                                )}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="space-y-4">
                                        <FormLabel className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 pl-1">{t("overviewLabel")}</FormLabel>
                                        <FormControl>
                                            <Textarea
                                                placeholder={t("overviewPlaceholder")}
                                                className="min-h-[160px] rounded-[2rem] bg-white border-slate-100 shadow-sm font-medium p-8 resize-none text-slate-600 leading-relaxed focus-visible:ring-primary/20 focus-visible:border-primary transition-all placeholder:text-slate-300"
                                                {...field}
                                            />
                                        </FormControl>
                                        <FormMessage className="text-xs font-bold text-rose-500 pl-1" />
                            ...
                            <FormField
                                ...
                                render={() => (
                                    <FormItem className="space-y-4">
                                        <FormLabel className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 pl-1">{t("goalsLabel")}</FormLabel>
                                        <div className="space-y-3">
                                            {goals.map((goal, index) => (
                                                <div key={index} className="flex gap-2">
                                                    <Input
                                                        ...
                                                        className="h-12 rounded-xl bg-white border-slate-100 shadow-sm font-medium px-4 focus-visible:ring-primary/20 transition-all"
                                                    />
                                                    <Button
                                                        type="button"
                                                        variant="outline"
                                                        onClick={() => removeGoal(index)}
                                                        className="h-12 w-12 rounded-xl p-0 border-slate-100 text-rose-500 hover:bg-rose-50"
                                                    >
                                                        <X size={18} />
                                                    </Button>
                                                </div>
                                            ...
                                            <Button
                                                ...
                                                variant="outline"
                                                onClick={addGoal}
                                                className="w-full h-12 rounded-xl border-dashed border-2 border-slate-200 text-slate-400 hover:border-primary hover:text-primary transition-all bg-white"
                                            >
                                                {t("addGoal")}
                                            </Button>
                                        </div>
                            ...
                            <FormField
                                ...
                                render={() => (
                                    <FormItem className="space-y-4">
                                        <FormLabel className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 pl-1">{t("achievementsLabel")}</FormLabel>
                                        <div className="space-y-3">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="space-y-4">
                                            ...
                                            <FormControl>
                                                <Input type="date" className="h-16 rounded-2xl bg-white border-slate-100 shadow-sm font-bold px-8 focus-visible:ring-primary/20 focus-visible:border-primary transition-all" {...field} />
                                            </FormControl>
                                            <FormMessage className="text-xs font-bold text-rose-500 pl-1" />
                                        </FormItem>
                                    )}
                                            ...
                                            >
                                                {isUploading ? (
                                                    <div className="flex flex-col items-center gap-4">
                                                        ...
                                                        <span className="text-xs font-black uppercase tracking-widest text-primary animate-pulse italic">{t("uploadingBanner")}</span>
                                                    </div>
                                                    ...
                                                    <div className="flex flex-col items-center gap-4 text-slate-400 group-hover:text-primary transition-all duration-500 text-slate-900 leading-none">
                                                        ...
                                                        <span className="text-xs font-black uppercase tracking-[0.2em] leading-relaxed italic">{t("selectBanner")}</span>
                                                    </div>
                                                )}
                                                <input
                                                    type="file"
