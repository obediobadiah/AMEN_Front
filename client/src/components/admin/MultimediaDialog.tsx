                        ...
                        <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-slate-900">
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="col-span-2 space-y-4">
                                            <FormLabel className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 pl-1">{tMedia("dialog.titleLabel")}</FormLabel>
                                            <FormControl>
                                                <Input
                                                    {...field}
                                                    placeholder={tMedia("dialog.titlePlaceholder")}
                                                    className="h-16 rounded-2xl bg-white border-slate-100 shadow-sm font-bold px-8 text-lg focus-visible:ring-primary/20 focus-visible:border-primary transition-all placeholder:text-slate-300 placeholder:font-medium"
                                                />
                                            </FormControl>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="space-y-4">
                                            <FormLabel className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 pl-1">{tMedia("filters.all")}</FormLabel>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="space-y-4">
                                            <FormLabel className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 pl-1">{tMedia("dialog.categoryLabel") || "Category"}</FormLabel>
                                            <FormControl>
                                                <Input
                                                    {...field}
                                                    placeholder="E.g. Nature, Community..."
                                                    className="h-14 rounded-2xl bg-white border-slate-100 shadow-sm font-bold px-4 focus-visible:ring-primary/20 focus-visible:border-primary transition-all placeholder:text-slate-300"
                                                />
                                            </FormControl>
                                            <FormMessage className="text-xs font-bold text-rose-500 pl-1" />
                                        </FormItem>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="col-span-2 space-y-4">
                                            <FormLabel className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 pl-1">{tMedia("dialog.albumLabel")}</FormLabel>
                                            <Select
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => {
                                        ...
                                        return (
                                            <FormItem className="col-span-2 space-y-4">
                                                <FormLabel className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 pl-1">
                                                ...
                                                {isVideo && (
                                                    <Input
                                                        ...
                                                        className="h-14 rounded-2xl bg-white border-slate-100 shadow-sm font-bold px-6 text-sm focus-visible:ring-primary/20 focus-visible:border-primary transition-all placeholder:text-slate-300"
                                                    />
                                                )}
                                                    ...
                                                    {urls.length > 0 ? (
                                                        <div className="grid grid-cols-2 gap-4">
                                                            {urls.map((url: string, idx: number) => (
                                                                <div key={idx} className="relative aspect-[21/9] rounded-[2.5rem] overflow-hidden border-none shadow-2xl group bg-slate-100">
                                                                    ...
                                                                    <Button
                                                                        ...
                                                                        variant="destructive"
                                                                        size="icon"
                                                                        className="absolute top-4 right-4 rounded-full w-10 h-10 shadow-2xl opacity-0 group-hover:opacity-100 transition-all duration-300 bg-rose-500 text-white hover:bg-rose-600 scale-90 group-hover:scale-100 z-10"
                                                                        onClick={(e) => {
                                                                            e.preventDefault();
                                                            ...
                                                            {isMultipleMode && (
                                                                <div className="relative aspect-[21/9] rounded-[2.5rem] border-2 border-dashed border-slate-200 bg-slate-50/50 hover:bg-white hover:border-primary/50 transition-all duration-500 flex flex-col items-center justify-center gap-2 group cursor-pointer">
                                                                    <Upload className="text-primary w-8 h-8 group-hover:scale-110 transition-transform duration-500" />
                                                                    <span className="text-xs font-black uppercase tracking-wider text-slate-400 group-hover:text-primary transition-colors">Add More</span>
                                                                    <Input
                                                                        type="file"
                                                                        accept={accept}
                                                                        multiple={true}
                                                        ...
                                                        <div className="relative h-48 rounded-[2.5rem] border-2 border-dashed border-slate-200 bg-slate-50/50 hover:bg-white hover:border-primary/50 transition-all duration-500 flex flex-col items-center justify-center gap-4 group mt-4">
                                                            ...
                                                            <span className="text-xs font-black uppercase tracking-[0.2em] text-slate-400 group-hover:text-primary transition-colors italic">
                                                                Drop your {isVideo ? "video(s)" : "photo(s)"} here
                                                            </span>
                                                            {isVideo && (
                                                                <span className="text-[10px] text-slate-400 font-medium mt-1">Max size 50MB per video</span>
                                                            )}
                                                            <Input
                                                                type="file"
                                                                accept={accept}
                                ...
                                {form.watch("type") === "video" && (
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="col-span-2 space-y-4">
                                                <FormLabel className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 pl-1">Video Thumbnail</FormLabel>
                                                <div className="space-y-0 text-slate-900 leading-none">
                                                    {field.value && getImageUrl(field.value) ? (
                                                        <div className="relative aspect-[21/9] rounded-[2.5rem] overflow-hidden border-none shadow-2xl group">
                                                            ...
                                                            <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center backdrop-blur-[2px]">
                                                                <div className="bg-white/90 backdrop-blur-md p-4 rounded-full shadow-2xl transform scale-75 group-hover:scale-100 transition-all duration-500 text-slate-900 leading-none">
                                                            ...
                                                            <Button
                                                                ...
                                                                variant="destructive"
                                                                size="icon"
                                                                className="absolute top-6 right-6 rounded-full w-10 h-10 shadow-2xl opacity-0 group-hover:opacity-100 transition-all duration-300 bg-rose-500 text-white hover:bg-rose-600 scale-90 group-hover:scale-100"
                                                        ...
                                                        <div className="relative h-48 rounded-[2.5rem] border-2 border-dashed border-slate-200 bg-slate-50/50 hover:bg-white hover:border-primary/50 transition-all duration-500 flex flex-col items-center justify-center gap-4 group">
                                                            <div className="p-6 bg-white rounded-[2rem] shadow-xl shadow-slate-200/50 transition-transform duration-500 group-hover:scale-110">
                                                                <ImageIcon className="text-primary" size={32} />
                                                            </div>
                                                            <span className="text-xs font-black uppercase tracking-[0.2em] text-slate-400 group-hover:text-primary transition-colors italic text-center px-10">Upload Video Thumbnail</span>
                                                            <Input
                                                                type="file"
                                                                accept="image/*"
                                                                className="absolute inset-0 opacity-0 cursor-pointer"
