    ...
    const renderCard = (item: Project) => {
        ...
        return (
            <div className="flex flex-col gap-4">
                <div className="w-full h-48 rounded-2xl overflow-hidden bg-slate-50 relative group-hover:shadow-xl transition-all duration-500 border-2 border-slate-100">
                    {item.image_url ? (
                        <img
